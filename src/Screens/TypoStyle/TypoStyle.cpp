...
RTC_DATA_ATTR boolean TypoStyle::darkMode = false;
...
void TypoStyle::drawWatchFace(tmElements_t currentTime) { //override this method to customize how the watch face looks
    ...
    int col1 = fgColor; //GxEPD_WHITE; // foreground colour
    int col2 = bgColor; //GxEPD_BLACK; // background colour
